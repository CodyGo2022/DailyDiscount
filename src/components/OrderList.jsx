    ...
    return (
        <div className="flex flex-col w-[80%] 3xl:w-[90%] 2xl:w-[95%] lg:items-center m-auto">
            ...
            <div className=" flex mt-[80px] items-center gap-5">
                ...
                <h1 className="font-semibold text-[1.75rem]"><span className="text-[#7F8DA1]">Orders / </span> Order List</h1>
            </div>
                ...
                <table className="w-[100%] table-auto">
                    <thead>
                        <tr>
                            ...
                            <td className="font-semibold text-[1.563rem] sm:text-[0.5rem] text-[#302F2F] p-3 border-solid border-[1px] border-[#000000]">Action</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td className="flex justify-center gap-5 text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 border-solid border-b-[1px] border-[#EEF0F2]"><FaEye size={25} fill='#09CCF6'/><FaTrashAlt size={25} fill='#F13B1F'/></td>
                        </tr>
                        <tr>
                            <td className="text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 border-solid border-b-[1px] border-[#EEF0F2]">J@gmail.com</td>
                            <td className="text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 border-solid border-b-[1px] border-[#EEF0F2]">YSS - Fleet Warden</td>
