        ...
        <div className="relative w-full">
            ...
            <div className="flex flex-col w-[80%] 3xl:w-[90%] 2xl:w-[95%] lg:items-center m-auto">
                ...
                <div className=" flex lg:w-full sm:flex-wrap lg:justify-center mt-[80px] items-center gap-5">
                    ...
                    <h1 className="font-semibold sm:text-[1.3rem] text-[1.75rem]"><span className="text-[#7F8DA1]">Orders / </span> Order List</h1>
                </div>
                ...
                <div className="mt-[21px] w-full">
                    <table className="w-[100%] table-auto">
                        <thead>
                            <tr>
                                <td className="relative font-semibold text-[1.563rem] lg:text-[1.2rem] sm:text-[0.6rem] text-[#302F2F] sm:p-1 p-3 border-solid border-[1px] border-[#000000] arrow-down ard">Email</td>
                                <td className="relative font-semibold text-[1.563rem] lg:text-[1.2rem] sm:text-[0.6rem] text-[#302F2F] sm:p-1 p-3 border-solid border-[1px] border-[#000000] arrow-down ard">Products</td>
                                <td className="relative font-semibold text-[1.563rem] lg:text-[1.2rem] sm:text-[0.6rem] text-[#302F2F] sm:p-1 p-3 border-solid border-[1px] border-[#000000] arrow-down ard">Price</td>
                                <td className="relative font-semibold text-[1.563rem] lg:text-[1.2rem] sm:text-[0.6rem] text-[#302F2F] sm:p-1 p-3 border-solid border-[1px] border-[#000000] arrow-down ard">Date</td>
                                <td className="relative font-semibold text-[1.563rem] lg:text-[1.2rem] sm:text-[0.6rem] text-[#302F2F] sm:p-1 p-3 border-solid border-[1px] border-[#000000] arrow-down ard">Status</td>
                                <td className="font-semibold text-[1.563rem] sm:text-[0.6rem] text-[#302F2F] p-3 border-solid border-[1px] border-[#000000]">Action</td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td className="text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 md:p-2 border-solid border-b-[1px] border-[#EEF0F2]">&#8369;500</td>
                                <td className="text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 md:p-1 border-solid border-b-[1px] border-[#EEF0F2]">July 4 2022</td>
                                ...
                                <td className="flex justify-center sm:gap-2 gap-5 text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 md:p-1 border-solid border-b-[1px] border-[#EEF0F2]"><FaEye size={25} className="item" onClick={handleClick} fill='#09CCF6'/><FaTrashAlt size={25} className="item" fill='#F13B1F'/></td>
                            </tr>
                            <tr>
                                <td className="text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 md:p-1 border-solid border-b-[1px] border-[#EEF0F2]">J@gmail.com</td>
                                <td className="text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 md:p-1 border-solid border-b-[1px] border-[#EEF0F2]">YSS - Fleet Warden</td>
                                ...
                                <td className="text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 md:p-1 border-solid border-b-[1px] border-[#EEF0F2]">July 4 2022</td>
                                <td className="text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 md:p-1 border-solid border-b-[1px] border-[#EEF0F2]">
                                    <p className="flex items-center justify-center rounded-[8px] py-1 text-[#FFFFFF] bg-[#FB8733]">Pending</p>
                                </td>
                                <td className="flex justify-center sm:gap-2 gap-5 text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 md:p-1 border-solid border-b-[1px] border-[#EEF0F2]"><FaEye size={25} className="item" fill='#09CCF6'/><FaTrashAlt size={25} className="item" fill='#F13B1F'/></td>
                            </tr>
                            <tr>
                                <td className="text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 md:p-1 border-solid border-b-[1px] border-[#EEF0F2]">J@gmail.com</td>
                                <td className="text-[1.125] sm:text-[0.5rem] text-[#4F4B4B] p-3 md:p-1 border-solid border-b-[1px] border-[#EEF0F2]">YSS - Fleet Warden</td>
                ...
                { showmodal 
                ? 
                    <div className="absolute top-0 w-full min-h-screen bg-black bg-opacity-80">
